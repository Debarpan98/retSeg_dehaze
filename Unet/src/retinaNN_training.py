...
patches_imgs_train, patches_masks_train = get_data_training(
    ...
    #replace 'train_imgs_original' with 'train_imgs_dehaze_original' while working on dehazed dataset
    DRIVE_train_imgs_original = path_data + config.get('data paths', 'train_imgs_original'),

    #replace 'train_groundTruth' with 'train_dehaze_groundTruth' while working on dehazed dataset
