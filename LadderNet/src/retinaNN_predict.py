...
DRIVE_test_imgs_original = path_data + config.get('data paths', 'test_imgs_dehaze_original')
test_imgs_orig = load_hdf5(DRIVE_test_imgs_original)
full_img_height = test_imgs_orig.shape[2]
full_img_width = test_imgs_orig.shape[3]
#the border masks provided by the DRIVE
DRIVE_test_border_masks = path_data + config.get('data paths', 'test_border_dehaze_masks')
...
#ground truth
gtruth= path_data + config.get('data paths', 'test_dehaze_groundTruth')
...
if average_mode == True:
    patches_imgs_test, new_height, new_width, masks_test = get_data_testing_overlap(
        ...
        DRIVE_test_groudTruth = path_data + config.get('data paths', 'test_dehaze_groundTruth'),  #masks
        Imgs_to_test = int(config.get('testing settings', 'full_images_to_test')),
