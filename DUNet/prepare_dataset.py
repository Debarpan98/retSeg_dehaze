...
imgs_train, groundTruth_train, border_masks_train = get_datasets(original_imgs_dehaze_train, groundTruth_imgs_dehaze_train, borderMasks_imgs_dehaze_train, "train")
write_hdf5(imgs_train, dataset_path + dataset + "_imgs_dehaze_train.hdf5")
write_hdf5(groundTruth_train, dataset_path + dataset + "_groundTruth_dehaze_train.hdf5")
write_hdf5(border_masks_train, dataset_path + dataset + "_borderMasks_dehaze_train.hdf5")

imgs_test, groundTruth_test, border_masks_test = get_datasets(original_imgs_test, groundTruth_imgs_test,
                                                              borderMasks_imgs_test, "test")
write_hdf5(imgs_test, dataset_path + dataset + "_imgs_dehaze_test.hdf5")
write_hdf5(groundTruth_test, dataset_path + dataset + "_groundTruth_dehaze_test.hdf5")
write_hdf5(border_masks_test, dataset_path + dataset + "_borderMasks_dehaze_test.hdf5")
